  ...
  return (
    <>
      <div className="container mt-5 ">
        <div className="row">
          <div className="col-12 col-md-5">
            <img src={loginPic} className="p-5 sing-img" />
          </div>
          <div className="col-12 col-md-2 "></div>
          <div className="col-12 col-md-5 p-5 margin">
            <div
              className="ml-5 margin"
              style={{ marginLeft: "20%", lineHeight: "2rem" }}
            >
              <h3 className="mt-5  margin">Signup now</h3>
      ...
      <div className="container">
        <div
          className="row text-muted text-center authorize"
          style={{ fontSize: "0.8rem" }}
        >
          <div className="">
            <p>
              I authorize Zerodha to contact me even if my number is registered
          ...
          <div className="">
            {" "}
            <p>
              Please visit to know more.<a href="">this article</a>
            </p>
          </div>
          <div className="">
            <p>

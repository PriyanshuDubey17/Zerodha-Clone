      ...
      <div className="container p-5 mt-5 border-top border-bottom">
        <div className="row mt-5 ">
          <div className="col-12 col-md-4 ">
            ...
            <h3 className="mt-3 free">Free equity delivery</h3>
            <p
              className=" pt-3  text-small text-muted free"
          ...
          <div className="col-12 col-md-4 ">
            ...
            <h3 className="mt-3 free">Intraday and F&O trades</h3>
            <p
              className=" pt-3 text-small text-muted free"
              style={{ lineHeight: "1.8rem" }}
            >
          ...
          <div className="col-12 col-md-4">
            <img
              ...
              style={{ width: "80%" }}
            />
            <h3 className="mt-3 free">Free direct MF</h3>
            <p
              className="pt-3 text-small text-muted free"
              style={{ lineHeight: "1.8rem" }}
            >

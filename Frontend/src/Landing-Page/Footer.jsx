        ...
        <div className="container p-5 border-top mt-5">
          <div className="row ">
            <div className="col-12 col-md-3">
              ...
              <p className="p-2 mt-3 text-muted " style={{ fontSize: "13px" }}>
                &copy;2010 - 2024, Zerodha Broking Ltd. All rights reserved.
              </p>
              <div className="fs-5 ">
                <a href="" className="mx-2">
                  <i className="fa-brands fa-twitter text-muted"></i>
                </a>
                <a href="" className="mx-2 ">
                  {" "}
                ...
                <a href="" className="mx-2 ">
                  <i className="fa-brands fa-linkedin text-muted"></i>
                </a>
              </div>
            ...
            <div className="col-12 col-md-3 ml-5">
              <h5>Company</h5>
              <a href="#" className=" footerAnchorTag text-muted ">
                {" "}
                About
              </a>
              <a href="#" className="footerAnchorTag text-muted  ">
          ...
          <div className="mt-5">
            <p className=" text-muted pr-3 " style={{ fontSize: "0.7rem" }}>
              ...
              <a href="">complaints@zerodha.com</a>,
              <a href=""> for DP related to dp@zerodha.com</a>. Please ensure
